module.exports = {
  ...
  postAttributes: `id, title, body, showHosted, voteCount, commentCount, isPinned, isLocked, timeCreated, timeUpdated, url, isAnnouncment, isAuthor, canEdit, canComment, canVote, canPin, canSetType, canChangeBoard, canLock, hasVoted, canReport, hasReported, isAnswer, isAnswerable, tutorialPages, preview(length: ${global.initVariables.markdown.length || 150}, removeMarkdown ${global.initVariables.markdown.removeMarkdown || true})`,
